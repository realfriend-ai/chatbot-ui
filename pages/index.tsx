...
import {GraphqlConf} from "@/components/Settings/GraphqlConf";
...
const GRAPHQL_ENDPOINT = 'https://graphql.chat/api/graphql-chat/graphql';
...
const Home: React.FC<HomeProps> = ({
    ...
    const [graphqlConf, setGraphqlConf] = useState<GraphqlConf>({});
    ...
    // FETCH RESPONSE ----------------------------------------------
    const [chatMutation, {loading, error}] = useMutation(CHAT_MUTATION, {client});
    ...
    const handleSend = async (message: Message, deleteCount = 0) => {
        if (selectedConversation) {
            ...
            const updatedMessages: Message[] = [
                ...
                {role: 'assistant', content: data.chat.answer},
            ];
